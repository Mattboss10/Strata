...
contract BaseScript is Script, Deployers {
    ...
    // --- Configure These ---
    /////////////////////////////////////
    IERC20 internal constant token0 = IERC20(0xD46836eaB8ED37C8A157E5668764B0549D9F2ff8);
    IERC20 internal constant token1 = IERC20(0x115f0E0648CCb0a6d936cFcEc1445a9d7Ec53c9B);
    IHooks constant hookContract = IHooks(0x53b1B0A39Eb0d674A2d8daa8D99C4FFA476BC080);
    /////////////////////////////////////
